                ...
                var httpCallback = function(success, data){
                    ...
                    if(success){
                        ...
                        var showMatchResultLayer = function(){
                            ...
                            matchGameOverLayer.init(false, null, null, laiyouCardValue, showDetailResult, matchLevel, self.m_pMyself.getScore(), myselfWinOrLoseScore, jsonObject.ContinuityWin);
